...
import com.codewithbisht.blog.payloads.CategoryDto;
import com.codewithbisht.blog.repositories.CategoryRepo;
import com.codewithbisht.blog.services.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
	...
	public List<CategoryDto> getCategories() {
		...
		List<CategoryDto> categoriesDto=categories.stream().map((i)->this.modelMapper.map(i,CategoryDto.class))
